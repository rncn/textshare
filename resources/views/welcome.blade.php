...
<body>
    ...
    <article>
        <section class="pr">
            ...
            <p class="pr-text">簡単にシンプルなテキストページを作成できます。テキストにスタイルを指定することもできます。<br>シンプルで広告に邪魔されることなくテキストを公開できます。<a href="/v/1">サンプル</a></p>
        </section>
        <section class="editor-ui">
            <div class="controll">
                ...
                <p><a href="https://about.rnicsn.com/terms.html" target="_blank">利用規約に同意して</a>公開します</p>
                <button type="button" onclick="send();" class="btn btn-success shadow-sm btn-block">公開</button>
            </div>
            <div id="editor">
                @if(old('content'))
                {!! old('content') !!}
